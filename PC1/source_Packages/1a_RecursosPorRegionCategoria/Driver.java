...
public class Driver {
	public static void main(String[] args) {
		...
		configuracion_job.setJobName("RecursosPorRegionCategoria");
		...
		configuracion_job.setMapperClass(RecursosPorRegionCategoria.Mapper.class);
		configuracion_job.setReducerClass(RecursosPorRegionCategoria.Reducer.class);
