...
public class Driver {
	public static void main(String[] args) {
		...
		configuracion_job.setJobName("RegresionLongitudDesdeLatitud");
		configuracion_job.setOutputKeyClass(Text.class);
		configuracion_job.setOutputValueClass(Text.class);
		configuracion_job.setMapperClass(RegresionLongitudDesdeLatitud.Mapper.class);
		configuracion_job.setReducerClass(RegresionLongitudDesdeLatitud.Reducer.class);
