...
public class Driver {
	public static void main(String[] args) {
		...
		configuracion_job.setJobName("RecursosPorProvinciaTipo");
		...
		configuracion_job.setMapperClass(RecursosPorProvinciaTipo.Mapper.class);
		configuracion_job.setReducerClass(RecursosPorProvinciaTipo.Reducer.class);
