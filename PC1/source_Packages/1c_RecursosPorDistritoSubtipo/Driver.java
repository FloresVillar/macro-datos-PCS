...
public class Driver {
	public static void main(String[] args) {
		...
		configuracion_job.setJobName("RecursosPorDistritoSubtipo");
		...
		configuracion_job.setMapperClass(RecursosPorDistritoSubtipo.Mapper.class);
		configuracion_job.setReducerClass(RecursosPorDistritoSubtipo.Reducer.class);
