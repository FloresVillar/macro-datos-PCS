...
public class Driver {
	public static void main(String[] args) {
		...
		configuracion_job.setJobName("ConteoPorProvincia");
		configuracion_job.setOutputKeyClass(Text.class);
		configuracion_job.setOutputValueClass(Text.class);
		configuracion_job.setMapperClass(ConteoPorProvincia.Mapper.class);
		configuracion_job.setReducerClass(ConteoPorProvincia.Reducer.class);
