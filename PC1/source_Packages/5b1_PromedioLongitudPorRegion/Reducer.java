...
public class Reducer extends MapReduceBase implements org.apache.hadoop.mapred.Reducer<Text, DoubleWritable, Text, DoubleWritable> {
	...
	// Calcula el promedio de longitud de cada región. Este resultado (chico)
	// es el que va a leer el segundo job de la cadena (ClasificarEsteOesteRegion)
	// vía DistributedCache.
