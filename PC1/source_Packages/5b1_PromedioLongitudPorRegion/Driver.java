...
public class Driver {
	public static void main(String[] args) {
		...
		configuracion_job.setJobName("PromedioLongitudPorRegion");
		...
		configuracion_job.setMapperClass(PromedioLongitudPorRegion.Mapper.class);
		configuracion_job.setReducerClass(PromedioLongitudPorRegion.Reducer.class);

		// Un solo Reducer: el segundo job de la cadena necesita este resultado
		// en un único part-file para poder leerlo entero como archivo de cache.
