...
public class Driver {
	public static void main(String[] args) {
		...
		configuracion_job.setJobName("ManifestacionesCulturalesPorRegion");
		...
		configuracion_job.setMapperClass(ManifestacionesCulturalesPorRegion.Mapper.class);
		configuracion_job.setReducerClass(ManifestacionesCulturalesPorRegion.Reducer.class);
