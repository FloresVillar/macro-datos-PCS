...
public class Driver {
	public static void main(String[] args) {
		...
		configuracion_job.setJobName("ExtremosGeograficosPorRegion");

		// Especificar el tipo de dato de la key y el value de salida
		// (Text/Text porque el resultado incluye nombres de recursos, no solo números)
		...
		configuracion_job.setMapperClass(ExtremosGeograficosPorRegion.Mapper.class);
		configuracion_job.setReducerClass(ExtremosGeograficosPorRegion.Reducer.class);
